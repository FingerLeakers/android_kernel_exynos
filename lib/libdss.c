...
for (i0 = 0; i0 < 8; i0++) {
for (i1 = 0; i1 < 1024; i1++) {
if (p->spinlock[i0][i1].time == 0) break;
printf("log.append({ 'type' : 'spinlock', 'time' : %lld.%09lld, 'cpu' : %d, 'sp' : %lu, 'jiffies' : %llu, 'next' : %hu, 'owner' : %hu, 'en' : %d, 'caller' :['%p', '%p', '%p', '%p',], 'lock' : '%p', })\n",
p->spinlock[i0][i1].time/1000000000LL,p->spinlock[i0][i1].time%1000000000LL,
i0,
p->spinlock[i0][i1].sp,
p->spinlock[i0][i1].jiffies,
p->spinlock[i0][i1].next,
p->spinlock[i0][i1].owner,
p->spinlock[i0][i1].en,
p->spinlock[i0][i1].caller[0] ? p->spinlock[i0][i1].caller[0] :(void**)-1,
p->spinlock[i0][i1].caller[1] ? p->spinlock[i0][i1].caller[1] :(void**)-1,
p->spinlock[i0][i1].caller[2] ? p->spinlock[i0][i1].caller[2] :(void**)-1,
p->spinlock[i0][i1].caller[3] ? p->spinlock[i0][i1].caller[3] :(void**)-1,
p->spinlock[i0][i1].lock ? p->spinlock[i0][i1].lock :(void**)-1);
}
}
for (i0 = 0; i0 < 1024; i0++) {
