...
#ifndef __S6E3HAB_HUBBLE_IRC_H__
#define __S6E3HAB_HUBBLE_IRC_H__
...
#define S6E3HAB_HUBBLE_HBM_COEF		4		// coef = 0.6, -> 10*(1-0.6)

static u8 irc_buffer[S6E3HAB_IRC_TOTAL_LEN];
static u8 irc_ref_tbl[S6E3HAB_IRC_TOTAL_LEN];


static struct panel_irc_info s6e3hab_hubble_irc = {
	...
	.hbm_coef = S6E3HAB_HUBBLE_HBM_COEF,
	.buffer = irc_buffer,
	.ref_tbl = irc_ref_tbl
};

#endif /* __S6E3HAB_HUBBLE_IRC_H__ */
