...
static struct seqinfo hubble1_a3_s0_no_osc_seqtbl[MAX_PANEL_SEQ];
...
static u8 hubble1_a3_s0_aid_table[][1] = {
...
static u8 hubble1_a3_s0_vfp_nm_table[][2] = {
...
static u8 hubble1_a3_s0_ltps_1_table[][8] = {
...
static u8 hubble1_a3_s0_ltps_2_table[][8] = {
...
static struct maptbl hubble1_a3_s0_maptbl[MAX_MAPTBL] = {
	[GAMMA_MAPTBL] = DEFINE_3D_MAPTBL(hubble1_a3_s0_gamma_table, init_gamma_table, getidx_dimming_maptbl, copy_gamma_maptbl),
	[AOR_MAPTBL] = DEFINE_3D_MAPTBL(hubble1_a3_s0_aor_table, init_aor_table, getidx_dimming_maptbl, copy_aor_maptbl),
	...
	[IRC_MAPTBL] = DEFINE_3D_MAPTBL(hubble1_a3_s0_irc_table, init_irc_table, getidx_dimming_maptbl, copy_irc_maptbl),
	...
	[AID_MAPTBL] = DEFINE_2D_MAPTBL(hubble1_a3_s0_aid_table, init_common_table, getidx_vrr_mode_table, copy_common_maptbl),
	[OSC_MAPTBL] = DEFINE_2D_MAPTBL(hubble1_a3_s0_osc_table, init_common_table, getidx_vrr_mode_table, copy_common_maptbl),
	[VFP_NM_MAPTBL] = DEFINE_2D_MAPTBL(hubble1_a3_s0_vfp_nm_table, init_common_table, getidx_vrr_mode_table, copy_common_maptbl),
	[LTPS_0_MAPTBL] = DEFINE_2D_MAPTBL(hubble1_a3_s0_ltps_0_table, init_common_table, getidx_vrr_mode_table, copy_common_maptbl),
	[LTPS_1_MAPTBL] = DEFINE_2D_MAPTBL(hubble1_a3_s0_ltps_1_table, init_common_table, getidx_vrr_mode_table, copy_common_maptbl),
	[LTPS_2_MAPTBL] = DEFINE_2D_MAPTBL(hubble1_a3_s0_ltps_2_table, init_common_table, getidx_vrr_mode_table, copy_common_maptbl),
...
#ifdef CONFIG_ACTIVE_CLOCK
	[ACTIVE_CLK_CTRL_MAPTBL] = DEFINE_0D_MAPTBL(hubble1_a3_s0_self_clk_ctrl_table, init_common_table, NULL, copy_self_clk_maptbl),
	[ACTIVE_CLK_SELF_DRAWER] = DEFINE_0D_MAPTBL(hubble1_a3_s0_self_drawer, init_common_table, NULL, copy_self_drawer),
	[ACTIVE_CLK_CTRL_UPDATE_MAPTBL] = DEFINE_0D_MAPTBL(hubble1_a3_s0_self_clk_update_table, init_common_table, NULL, copy_self_clk_update_maptbl),
#endif
#ifdef CONFIG_SUPPORT_GRAM_CHECKSUM
	...
	[POC_COMP_MAPTBL] = DEFINE_3D_MAPTBL(hubble1_a3_s0_poc_comp_table, init_common_table, getidx_dimming_maptbl, copy_common_maptbl),
};
...
#ifdef CONFIG_ACTIVE_CLOCK
static u8 HUBBLE1_A3_S0_ENABLE_ACTIVE_CLK[] = {
	0xE3,
...
static u8 HUBBLE1_A3_S0_UPDATE_ACTIVE_CLK[] = {
	0xE3,
	0x00, 0x00, 0x00, 0x08, 0x11, 0x00, 0x00, 0x00,
	0x03, 0x01,
};
static u8 HUBBLE1_A3_S0_DISABLE_ACTIVE_CLK[] = {
	0xE3,
	0x00, 0x00
};
static u8 HUBBLE1_A3_S0_SET_SELF_DRAWER[] = {
	0xE2,
...
static u8 HUBBLE1_A3_S0_DISABLE_SELF_DRAWER[] = {
	0xE2,
	0x00, 0x00
};
#endif
...
static u8 HUBBLE1_A3_S0_IRC_ON[] = { S6E3HAB_IRC_REG, 0x2E };
#ifdef CONFIG_SUPPORT_HMD
static u8 HUBBLE1_A3_S0_IRC_OFF[] = { S6E3HAB_IRC_REG, 0x25 };
#endif
...
static u8 HUBBLE1_A3_S0_LPM_NIT[] = {0xBB, 0x05, 0x0C, 0x00, 0x18, 0x0C, 0x43, 0x00};
...
static u8 HUBBLE1_A3_S0_MCD_ON_03[] = {
	0xB7,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static u8 HUBBLE1_A3_S0_MCD_ON_04[] = { 0xB1, 0x00, 0x18 };
static u8 HUBBLE1_A3_S0_MCD_ON_05[] = { 0xF6, 0x00 };
static u8 HUBBLE1_A3_S0_MCD_ON_06[] = { 0xCC, 0x12 };
...
static u8 HUBBLE1_A3_S0_MCD_OFF_03[] = {
	0xB7,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static u8 HUBBLE1_A3_S0_MCD_OFF_04[] = { 0xB1, 0x00, 0x18 };
static u8 HUBBLE1_A3_S0_MCD_OFF_05[] = { 0xF6, 0x69 };
static u8 HUBBLE1_A3_S0_MCD_OFF_06[] = { 0xCC, 0x00 };
...
static u8 HUBBLE1_A3_S0_GAMMA_INTER_CONTROL[] = {
	0xB1,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
static DEFINE_STATIC_PACKET(hubble1_a3_s0_osc_96_5m_ffc, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_OSC_96_5M_FFC, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_ffc, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_FFC, 0);
...
static u8 HUBBLE1_A3_S0_LTPS_1[] = { 0xCB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
static DEFINE_PKTUI(hubble1_a3_s0_ltps_1, &hubble1_a3_s0_maptbl[LTPS_1_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(hubble1_a3_s0_ltps_1, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_LTPS_1, 0x54);

static u8 HUBBLE1_A3_S0_LTPS_2[] = { 0xCB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
static DEFINE_PKTUI(hubble1_a3_s0_ltps_2, &hubble1_a3_s0_maptbl[LTPS_2_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(hubble1_a3_s0_ltps_2, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_LTPS_2, 0x8E);
...
#ifdef CONFIG_ACTIVE_CLOCK
static DEFINE_PKTUI(hubble1_a3_s0_enable_active_clk, &hubble1_a3_s0_maptbl[ACTIVE_CLK_CTRL_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(hubble1_a3_s0_enable_active_clk, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_ENABLE_ACTIVE_CLK, 0);
static DEFINE_PKTUI(hubble1_a3_s0_set_self_drawer, &hubble1_a3_s0_maptbl[ACTIVE_CLK_SELF_DRAWER], 1);
static DEFINE_VARIABLE_PACKET(hubble1_a3_s0_set_self_drawer, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_SET_SELF_DRAWER, 0);
static DEFINE_PKTUI(hubble1_a3_s0_update_active_clk, &hubble1_a3_s0_maptbl[ACTIVE_CLK_CTRL_UPDATE_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(hubble1_a3_s0_update_active_clk, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_UPDATE_ACTIVE_CLK, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_disable_self_drawer, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_DISABLE_SELF_DRAWER, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_disable_active_clk, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_DISABLE_ACTIVE_CLK, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_active_clk_img_pkt, DSI_PKT_TYPE_WR_SR, live_clock_image, 0);
#endif
...
static DEFINE_PKTUI(hubble1_a3_s0_gamma_inter_control, &hubble1_a3_s0_maptbl[GAMMA_INTER_CONTROL_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(hubble1_a3_s0_gamma_inter_control, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_GAMMA_INTER_CONTROL, S6E3HAB_GAMMA_INTER_OFS);
...
static DEFINE_STATIC_PACKET(hubble1_a3_s0_irc_on, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_IRC_ON, 0);
#ifdef CONFIG_SUPPORT_HMD
static DEFINE_STATIC_PACKET(hubble1_a3_s0_irc_off, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_IRC_OFF, 0);
#endif
#ifdef CONFIG_SUPPORT_DDI_CMDLOG
...
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_on_03, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_ON_03, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_on_04, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_ON_04, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_on_05, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_ON_05, 0x11);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_on_06, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_ON_06, 0x04);
...
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_off_03, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_OFF_03, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_off_04, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_OFF_04, 0);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_off_05, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_OFF_05, 0x11);
static DEFINE_STATIC_PACKET(hubble1_a3_s0_mcd_off_06, DSI_PKT_TYPE_WR, HUBBLE1_A3_S0_MCD_OFF_06, 0x04);
...
static DEFINE_PANEL_MDELAY(hubble1_a3_s0_wait_sleep_out, 10);
...
static DEFINE_PANEL_TIMER_MDELAY(hubble1_a3_s0_wait_dispon, 100);
static DEFINE_PANEL_TIMER_BEGIN(hubble1_a3_s0_wait_dispon,
		TIMER_DLYINFO(&hubble1_a3_s0_wait_dispon));
...
static void *hubble1_a3_s0_no_osc_init_cmdtbl[] = {
	...
	&DLYINFO(hubble1_a3_s0_wait_sleep_out),
	&TIMER_DLYINFO_BEGIN(hubble1_a3_s0_wait_dispon),
	&PKTINFO(hubble1_a3_s0_ssd_improve),
...
//	&KEYINFO(hubble1_a3_s0_level3_key_disable),
	...
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
	&SEQINFO(hubble1_a3_s0_no_osc_seqtbl[PANEL_SET_BL_SEQ]),
#ifdef CONFIG_EXYNOS_DECON_LCD_COPR
...
static void *hubble1_a3_s0_init_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_isc),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
	&SEQINFO(hubble1_a3_s0_seqtbl[PANEL_SET_BL_SEQ]),
#ifdef CONFIG_EXYNOS_DECON_LCD_COPR
	&SEQINFO(hubble1_a3_s0_copr_seqtbl[COPR_SET_SEQ]),
#endif
};
...
static void *hubble1_a3_s0_set_bl_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_ltps_1),
	&PKTINFO(hubble1_a3_s0_ltps_2),
...
static void *hubble1_a3_s0_hmd_bl_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_acl_control),
	&PKTINFO(hubble1_a3_s0_acl_dim_frm),
	&PKTINFO(hubble1_a3_s0_acl_onoff),
...
static void *hubble1_a3_s0_alpm_exit_cmdtbl[] = {
	&KEYINFO(hubble1_a3_s0_level2_key_enable),
#ifdef CONFIG_ACTIVE_CLOCK
	&PKTINFO(hubble1_a3_s0_disable_active_clk),
	&PKTINFO(hubble1_a3_s0_disable_self_drawer),
#endif
...
static void *hubble1_a3_s0_gamma_inter_control_cmdtbl[] = {
	&KEYINFO(hubble1_a3_s0_level2_key_enable),
	&PKTINFO(hubble1_a3_s0_gamma_inter_control),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
};
...
static void *hubble1_a3_s0_dsu_mode_cmdtbl[] = {
	...
	&SEQINFO(s6e3hab_hubble1_aod_seqtbl[DISABLE_SELF_MOVE_SEQ]),
	&DLYINFO(hubble1_a3_s0_wait_1_frame_in_60hz),
	&DLYINFO(hubble1_a3_s0_wait_1_frame_in_60hz),
#endif
	&KEYINFO(hubble1_a3_s0_level1_key_enable),
...
static void *hubble1_a3_s0_set_fps_cmdtbl[] = {
	&TIMER_DLYINFO(hubble1_a3_s0_wait_dispon),
	&SEQINFO(hubble1_a3_s0_seqtbl[PANEL_SET_BL_SEQ]),
};
...
static void *hubble1_a3_s0_mcd_on_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_mcd_on_05),
	&PKTINFO(hubble1_a3_s0_mcd_on_06),
	&PKTINFO(hubble1_a3_s0_gamma_update_enable),
...
static void *hubble1_a3_s0_mcd_off_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_mcd_off_05),
	&PKTINFO(hubble1_a3_s0_mcd_off_06),
	&PKTINFO(hubble1_a3_s0_gamma_update_enable),
	&DLYINFO(hubble1_a3_s0_wait_100msec),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
};
...
#ifdef CONFIG_ACTIVE_CLOCK
static void *hubble1_a3_s0_active_clk_img_cmdtbl[] = {
	&PKTINFO(hubble1_a3_s0_active_clk_img_pkt),
};

static void *hubble1_a3_s0_active_clk_ctrl_cmdtbl[] = {
	&KEYINFO(hubble1_a3_s0_level2_key_enable),
	&PKTINFO(hubble1_a3_s0_enable_active_clk),
	&PKTINFO(hubble1_a3_s0_set_self_drawer),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
};

static void *hubble1_a3_s0_active_clk_update_cmdtbl[] = {
	&KEYINFO(hubble1_a3_s0_level2_key_enable),
	&PKTINFO(hubble1_a3_s0_enable_active_clk),
	&PKTINFO(hubble1_a3_s0_set_self_drawer),
	&DLYINFO(hubble1_a3_s0_wait_1_frame_in_30hz),
	&PKTINFO(hubble1_a3_s0_update_active_clk),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
};
#endif
...
static struct seqinfo hubble1_a3_s0_preliminary_no_osc_seqtbl[MAX_PANEL_SEQ] = {
	[PANEL_INIT_SEQ] = SEQINFO_INIT("init-seq", hubble1_a3_s0_no_osc_init_cmdtbl),
...
#endif
	[PANEL_FPS_SEQ] = SEQINFO_INIT("set-fps-seq", hubble1_a3_s0_set_fps_cmdtbl),
...
#endif
#ifdef CONFIG_ACTIVE_CLOCK
	[PANEL_ACTIVE_CLK_IMG_SEQ] = SEQINFO_INIT("active-clk-img-seq", hubble1_a3_s0_active_clk_img_cmdtbl),
	[PANEL_ACTIVE_CLK_CTRL_SEQ] = SEQINFO_INIT("active-clk-ctrl-seq", hubble1_a3_s0_active_clk_ctrl_cmdtbl),
	[PANEL_ACTIVE_CLK_UPDATE_SEQ] = SEQINFO_INIT("active-clk-update-seq", hubble1_a3_s0_active_clk_update_cmdtbl),
#endif
#ifdef CONFIG_SUPPORT_GRAM_CHECKSUM
...
struct common_panel_info s6e3hab_hubble1_a3_s0_preliminary_no_osc_panel_info = {
	.ldi_name = "s6e3hab",
	.name = "s6e3hab_hubble1_a3_s0_preliminary_no_osc",
	.model = "AMB675TG01",
	.vendor = "SDC",
	.id = 0x810001,
	.rev = 0,
	...
	.seqtbl = hubble1_a3_s0_preliminary_no_osc_seqtbl,
	.nr_seqtbl = ARRAY_SIZE(hubble1_a3_s0_preliminary_no_osc_seqtbl),
...
struct common_panel_info s6e3hab_hubble1_a3_s0_default_no_osc_panel_info = {
	.ldi_name = "s6e3hab",
	.name = "s6e3hab_hubble1_a3_s0_default_no_osc",
	.model = "AMB675TG01",
	.vendor = "SDC",
	.id = 0x810002,
	.rev = 0,
	...
	.maptbl = hubble1_a3_s0_maptbl,
	.nr_maptbl = ARRAY_SIZE(hubble1_a3_s0_maptbl),
	.seqtbl = hubble1_a3_s0_no_osc_seqtbl,
	.nr_seqtbl = ARRAY_SIZE(hubble1_a3_s0_no_osc_seqtbl),
	.rditbl = s6e3hab_rditbl,
	.nr_rditbl = ARRAY_SIZE(s6e3hab_rditbl),
	.restbl = s6e3hab_restbl,
	.nr_restbl = ARRAY_SIZE(s6e3hab_restbl),
...
{
	register_common_panel(&s6e3hab_hubble1_a3_s0_preliminary_no_osc_panel_info);
	register_common_panel(&s6e3hab_hubble1_a3_s0_preliminary_panel_info);
	register_common_panel(&s6e3hab_hubble1_a3_s0_default_no_osc_panel_info);
