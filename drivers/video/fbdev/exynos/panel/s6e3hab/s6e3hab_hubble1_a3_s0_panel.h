...
static u8 hubble1_a3_s0_elvss_table[MAX_S6E3HAB_VRR][3][S6E3HAB_HUBBLE_TOTAL_NR_LUMINANCE][1] = {
	[S6E3HAB_VRR_60_NORMAL] = {
		{
			/* OVER_ZERO */
			{ 0x11 }, { 0x11 }, { 0x11 }, { 0x11 }, { 0x11 }, { 0x11 }, { 0x11 }, { 0x11 }, { 0x13 }, { 0x13 },
			{ 0x13 }, { 0x13 }, { 0x13 }, { 0x13 }, { 0x13 }, { 0x13 }, { 0x13 }, { 0x13 }, { 0x14 }, { 0x14 },
			{ 0x14 }, { 0x14 }, { 0x14 }, { 0x14 }, { 0x14 }, { 0x15 }, { 0x16 }, { 0x17 }, { 0x18 }, { 0x19 },
			{ 0x19 }, { 0x19 }, { 0x19 }, { 0x19 }, { 0x19 }, { 0x19 }, { 0x19 }, { 0x19 }, { 0x19 }, { 0x19 },
			{ 0x19 }, { 0x1B }, { 0x1D }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 },
		...
		},
		{
			...
			{ 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 },
			{ 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 }, { 0x17 },
			{ 0x17 }, { 0x1B }, { 0x1D }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 }, { 0x20 },
			{ 0x20 }, { 0x20 }, { 0x20 }, { 0x1F }, { 0x1F }, { 0x1E }, { 0x1E }, { 0x1D }, { 0x1D }, { 0x1C },
			{ 0x1B }, { 0x1B }, { 0x1A }, { 0x19 }, { 0x19 }, { 0x18 }, { 0x18 }, { 0x18 }, { 0x18 }, { 0x17 },
			{ 0x17 }, { 0x17 }, { 0x16 }, { 0x16 },
			/* HBM */
...
static DEFINE_PANEL_TIMER_MDELAY(hubble1_a3_s0_mfapc_delay, 130);
static DEFINE_PANEL_TIMER_BEGIN(hubble1_a3_s0_mfapc_delay,
		TIMER_DLYINFO(&hubble1_a3_s0_mfapc_delay));
#endif
...
static void *hubble1_a3_s0_preliminary_osc_96_5m_init_cmdtbl[] = {
...
#ifdef CONFIG_SUPPORT_MAFPC
	&TIMER_DLYINFO_BEGIN(hubble1_a3_s0_mfapc_delay),
	&KEYINFO(hubble1_a3_s0_level3_key_enable),
	&PKTINFO(hubble1_a3_s0_mafpc_flash_sel_off),
	&KEYINFO(hubble1_a3_s0_level3_key_disable),
	...
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
	&SEQINFO(hubble1_a3_s0_preliminary_osc_96_5m_seqtbl[PANEL_FPS_SEQ]),
#ifdef CONFIG_EXYNOS_DECON_LCD_COPR
...
static void *hubble1_a3_s0_preliminary_init_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_isc),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
	&SEQINFO(hubble1_a3_s0_preliminary_seqtbl[PANEL_FPS_SEQ]),
#ifdef CONFIG_EXYNOS_DECON_LCD_COPR
	&SEQINFO(hubble1_a3_s0_copr_seqtbl[COPR_SET_SEQ]),
#endif
};
...
static void *hubble1_a3_s0_osc_96_5m_init_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_isc),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
	&SEQINFO(hubble1_a3_s0_osc_96_5m_seqtbl[PANEL_FPS_SEQ]),
#ifdef CONFIG_EXYNOS_DECON_LCD_COPR
	&SEQINFO(hubble1_a3_s0_copr_seqtbl[COPR_SET_SEQ]),
#endif
};
...
static void *hubble1_a3_s0_init_cmdtbl[] = {
	...
	&PKTINFO(hubble1_a3_s0_isc),
	&KEYINFO(hubble1_a3_s0_level2_key_disable),
	&SEQINFO(hubble1_a3_s0_seqtbl[PANEL_FPS_SEQ]),
#ifdef CONFIG_EXYNOS_DECON_LCD_COPR
	&SEQINFO(hubble1_a3_s0_copr_seqtbl[COPR_SET_SEQ]),
#endif
};
...
#endif
#ifdef CONFIG_SUPPORT_MAFPC
	[PANEL_MAFC_IMG_SEQ] = SEQINFO_INIT("mafpc-img-seq", hubble1_a3_s0_mafpc_image_cmdtbl),
	[PANEL_MAFC_ON_SEQ] = SEQINFO_INIT("mafpc-on-seq", hubble1_a3_s0_mafpc_on_cmdtbl),
	[PANEL_MAFC_OFF_SEQ] = SEQINFO_INIT("mafpc-off-seq", hubble1_a3_s0_mafpc_off_cmdtbl),
