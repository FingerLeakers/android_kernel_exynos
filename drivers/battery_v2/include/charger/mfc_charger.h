...
#if defined(CONFIG_WIRELESS_FIRMWARE_64)
#define MFC_FW_BIN_VERSION			0x64
#define MFC_FW_BIN_FULL_VERSION		0x00640001
#define MFC_FW_BIN_VERSION_ADDR		0x1674 //fw rev64 address
#define MFC_FLASH_FW_HEX_PATH		"mfc/mfc_fw64_flash.bin"
#define MFC_FW_SDCARD_BIN_PATH		"/sdcard/mfc_fw64_flash.bin"
#else
