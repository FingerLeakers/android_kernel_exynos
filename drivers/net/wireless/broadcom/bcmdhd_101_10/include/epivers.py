...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=int(os.getenv('EPIVERS_VERBOSE', 0)),
...
def main():
    ...
    pathstyle = os.path.abspath if opts.verbose else os.path.relpath
    ...
    assert rev, 'unable to derive revision'
    ...
    with tempfile.NamedTemporaryFile(
        delete=False, dir=os.path.dirname(header),
